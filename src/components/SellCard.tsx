...
const SellCard: React.FC<SellCardProps> = ({
  ...
  return (
    <div className="col-md-6 d-flex justify-content-center mt-5 mb-5">
      ...
      <div className="card shadow" style={{ width: '450px', height: '600px' }}>
        <img
          src={image}
          alt={`Product ${title}`}
...
<Link to={`/shop/product/${id_post}`} className="no-link-style">
        <div className="card-body d-flex flex-column" style={{ height: "200px"}}>
          ...
          <h5 className="card-text custom-line-height ms-2 mt-2">
            ฿ {price}
          </h5>
          <div className="d-flex flex-wrap gap-2 mt-2 mb-3 justify-content-start">
